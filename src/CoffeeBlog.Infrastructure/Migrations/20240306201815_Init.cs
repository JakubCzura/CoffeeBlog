    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                LastPassword3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                UserId = table.Column<int>(type: "int", nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_UserLastCredential", x => x.Id);
                table.ForeignKey(
                    name: "FK_UserLastCredential_User_UserId",
                    column: x => x.UserId,
                    principalTable: "User",
                    principalColumn: "Id",
        ...
        migrationBuilder.CreateIndex(
            name: "IX_UserLastCredential_UserId",
            table: "UserLastCredential",
            column: "UserId");
