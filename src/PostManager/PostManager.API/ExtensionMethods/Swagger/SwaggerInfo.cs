...
namespace PostManager.API.ExtensionMethods.Swagger;
...
public static class SwaggerInfo
{
    ...
    /// </summary>
    public const string ProjectNameJson = "CoffeeBlog-PostManager-swagger.json";
    ...
    /// </summary>
    public const string DocumentTitle = "CoffeeBlog - PostManager Documentation";
    ...
    public static OpenApiInfo SwaggerDocumentInfo(OpenApiInfo version) => new()
    {
        ...
        Description = "Swagger of Web API of PostManager created for CoffeeBlog",
