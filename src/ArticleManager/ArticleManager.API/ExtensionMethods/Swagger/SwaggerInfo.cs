...
public static class SwaggerInfo
{
    ...
    /// </summary>
    public const string ProjectNameJson = "CoffeeBlog-ArticleManager-swagger.json";
    ...
    /// </summary>
    public const string DocumentTitle = "CoffeeBlog - ArticleManager Documentation";
    ...
    public static OpenApiInfo SwaggerDocumentInfo(OpenApiInfo version) => new()
    {
        ...
        Description = "Swagger of Web API of ArticleManager created for CoffeeBlog",
