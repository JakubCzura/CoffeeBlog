...
public static class SwaggerInfo
{
    ...
    /// </summary>
    public const string ProjectNameJson = "CoffeeBlog-NotificationProvider-swagger.json";
    ...
    /// </summary>
    public const string DocumentTitle = "CoffeeBlog - NotificationProvider Documentation";
    ...
    public static OpenApiInfo SwaggerDocumentInfo(OpenApiInfo version) => new()
    {
        ...
        Description = "Swagger of Web API of NotificationProvider created for CoffeeBlog",
