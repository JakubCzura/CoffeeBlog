...
using NotificationProvider.Application.ExtensionMethods.Automapper.RequestDetails;

namespace NotificationProvider.Application.Commands.RequestDetails.CreateRequestDetail;
